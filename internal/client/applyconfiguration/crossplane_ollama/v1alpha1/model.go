...
type ModelApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	...
	Status                           *ollamav1alpha1.ModelStatusApplyConfiguration `json:"status,omitempty"`
}
...
func Model(name, namespace string) *ModelApplyConfiguration {
	...
	b.WithKind("Model")
	b.WithAPIVersion("ollama.crossplane.aerf.io/v1alpha1")
	return b
}
...
func (b *ModelApplyConfiguration) WithStatus(value *ollamav1alpha1.ModelStatusApplyConfiguration) *ModelApplyConfiguration {
	b.Status = value
	return b
}

...
func (in *ForProvider) DeepCopyInto(out *ForProvider) {
	*out = *in
	in.ModelSpec.DeepCopyInto(&out.ModelSpec)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ForProvider.
func (in *ForProvider) DeepCopy() *ForProvider {
	if in == nil {
		return nil
	}
	out := new(ForProvider)

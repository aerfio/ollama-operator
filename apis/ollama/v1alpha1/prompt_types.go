...
// +kubebuilder:printcolumn:name="EVAL_RATE",type="string",JSONPath=".status.metrics.evalRate"
// +kubebuilder:printcolumn:name="PROMPT_EVAL_RATE",type="string",JSONPath=".status.metrics.promptEvalRate"
